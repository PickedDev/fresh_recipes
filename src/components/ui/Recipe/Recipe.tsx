            ...
            <div className={styles.formWrapper}>
                ...
                <div className={styles.formInner}>
                    {/* <div className={styles.recipeImgWrapper}>
                            <img className={styles.recipeImg} src="https://via.placeholder.com/520x200" alt="" />
                        </div> */}
                    <div className={styles.Item}>
                        <span className={styles.ItemTitle}>Описание</span>
                        <div className={styles.ItemDescription}>{recipe.description}</div>
                    </div>
                    <div className={styles.Item}>
                        <span className={styles.ItemTitle}>Время готовки (в минутах)</span>
                        <div className={styles.ItemDescription}>
                            <img src={Time} alt="" className={styles.images} />
                            <span> {recipe.time}</span>
                        </div>
                    </div>
                    <div className={styles.Item}>
                        <span className={styles.ItemTitle}>Ингридиенты</span>
                    ...
                    <div className={styles.Item}>
                        <span className={styles.ItemTitle}>Инструкция приготовления</span>
                        <div className={styles.ItemLists}>
                            {recipe.steps.map((x, index) => (
                                <div className={styles.ingridients2}>
                    ...
                    <div className={styles.heading}> Приятного апетита!</div>
                    <div className={styles.buttons}>
                        <Button color="primary" className={styles.btnDelete}>
                            {' '}
                            Удалить рецепт{' '}
                        </Button>
